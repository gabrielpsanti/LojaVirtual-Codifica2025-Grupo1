@csrf
<div class="space-y-2">
    <label for="nome" class="text-sm font-semibold text-slate-700">Nome da cor</label>
    <input type="text" name="nome" id="nome" value="{{ old('nome', $cor->nome ?? '') }}"
        class="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-slate-900 outline-none transition"
        placeholder="Ex.: Azul" autofocus>
